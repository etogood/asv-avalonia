...
public class EditConnectionPortHistoryCommand : NoContextCommand
{
    #region Static

    public const string Id = $"{BaseId}.editPort";
    ...
    public EditConnectionPortHistoryCommand(IMavlinkConnectionService connectionService)
    {
